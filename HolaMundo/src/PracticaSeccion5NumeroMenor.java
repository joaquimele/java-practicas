...
public class PracticaSeccion5NumeroMenor {
    public static void main(String[] args) {
        ...
        if (cantidad < 10) {
            ...
            int menor = Integer.MAX_VALUE; // asignamos un valor máximo por defecto como numero menor para comenzar - el valor es 2147483647
            int numero;
