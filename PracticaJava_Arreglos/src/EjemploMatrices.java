public class EjemploMatrices {
    public static void main(String[] args) {
        ...
        System.out.println("número de filas: " + numeros.length); //Largo de filas
        System.out.println("número de columnas: " + numeros[0].length); //Cantidad de elementos en la columna 0 de 4
